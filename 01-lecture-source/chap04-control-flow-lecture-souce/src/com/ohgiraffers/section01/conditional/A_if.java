...
public class A_if {
    ...
    public void testSimpleIfStatement(){
        ...
        /* if문은 조건식 결과 값이 참(true)이면 {}안의 코드를 실행하고,
         * 조건식 결과 값이 거짓(false)이면 {}안의 코드를 무시하고 넘어감.
         *
         * */

        /*정수 한 개를 입력받아 그 수가 짝수이면 입력하신 숫자는 짝수입니다 라고 출력하고,
         * 짝수가 아니면 출력하지 않는 구문을 만들어보자.
         * 단, 조건과 관련없이 프로그램이 종료될 떄 프로그램을 종료합니다 라고 출력되도록 하자.*/
    ...
    public void testNestedIfStetement(){
