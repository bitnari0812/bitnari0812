...
public class D_switch {
    public void testSipleSwichStatement() {

        /*수업목표. switch 단독 사용에 대한 흐름을 이해하고 적용할 수 있다.
         * [switch 표현식]
         * switch(비교할 변수)
        ...
        /*여러 개의 비교값 중 일치하는 조건에 해당하는 로직을 실행하는 것을 if-else-if)와 유사하다
         * 따라서 일부 호환이 가능하다
         * 하지만 swich문으로 비교 가능한 값은 정수, 문자, 문자열 형태의 값이다.
         * 실수와 논리는 비교할 수 없다.
         * 또한 정확하게 일치하는 경우만 비교할 수 있으며 대소 비교를 할 수 없다는 점이 차이점이다.
         * case절에는 변수를 사용하지 못한다(값만 비교가능)
         * 또한, 문자열 비교는 jdk 1.7 이상부터 가능하다*/

        /*정수 두 개의 연산 기호 문자를 입력 받아서
    ...
    public void testSwitchVendingMachine(){
        ...
        /*수업목표. switch문에 내에 break문에 대해 흐름을 이해하고 적용할 수 있다.*/
        /*switch문을 이용하여 문자열 값 비교 및 break문 테스트*/
        /*
        * 1. jdk 1.7이상의 switch문을 사용하여 문자열을 비교할 수 있다.
