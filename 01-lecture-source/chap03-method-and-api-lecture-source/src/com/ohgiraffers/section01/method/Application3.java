...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*지역변수는 선언한 메소드 블럭 내부에서 사용이 가능하다. 이것을 지역변수의 스코프라고 함.
        * 다른 메소드간 서로 공유해야하는 값이 존재하는 경우 메소드를 호출시 괄호 이용해서 값을 전달할 수 있다.
        * 이때 전달하는 값을 전달인자(argument)라고 부르고,
        * 메소드 선언부 괄호 안에 전달인자를 받기 위해 선언하는 변수를 매개변수(parameter)라고 한다. */
