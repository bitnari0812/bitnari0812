...
//    public void nonStaticMethod(){}        //추상 메소드가 아니면 말드지 못함.
    public abstract void nonStaticMethod();  //추상 메소드만 생성 가능

    /*
    * 인터페이스 안에 작성한 메소드는 묵시적으로  public abstract의 의미를 가진다.
    * 따라서 인터페이스 메소드를 오버라이딩하는 경우
    * 반드시 접근제한자를 public 으로 해야 오버라이딩이 가능
    * */
    ...
    /*default 키워드를 사용하면 non-static 메소드도 작성가능(JDK 1.8에 추가된 기능)*/
