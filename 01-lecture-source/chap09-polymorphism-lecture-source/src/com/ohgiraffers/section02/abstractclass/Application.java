...
public class Application {
    public static void main(String[] args) {
        ...
        * 추상클래스를 사용하려면 추상클래스를 상속받는 하위클래스를 이용하여 인스턴스를 생성해야 한다.
        * 이때 추상클래스는 상위 타입으로 사용될 수 있으며 다형성을 이용할 수 있다.
        * */

        /*
        * 추상클래스에 작성된 추상메소드는 반드시 후손이 오버라이딩해서 작성해야 하며,
        * 후손클래스들 메소드들의 공통 인터페이스로의 역할을 수정할 수 있다.
        * 추상클래스에서 작성한 메소드를 호출하게 되면 실제 후손 타입의 인스턴스가 가지는 메소드는
...
//        Product product = new Product();    // 추상클래스는 인스턴스 생성불가
        ...
        /*
        * 추상클래스를 왜 쓰냐?
        * 추상클래스의 추상메소드는 오버라이딩이 대한 강제성이 부여된다.
        * 따라서, 여러 클래스들을 그룹화하여 필수 기능을 정의하여 강제성을 부여해 개발시 일관된 인터페이스를 제공할 수 있다.
        * */
