...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 객체지향 프로그램의 꽃이라고 불릴 정도로 활용성이 높고 장점이 많다.
        ...
        *    (다양한 기능을 사용하는데 있어서 관리해야 할 메시지 종류가 줄어들게 된다)
...
//        Tiger t = new Animal();            //에러남
        ...
        * 런타임 당시에 객체가 가진 오버라이딩된 메소드로 바인딩이 바뀌어 동작하는 것
        *
        * */
        a1.cry();
        a2.cry();
...
//        ((Tiger)a1).bite();             //에러남. 토끼는 호랑이가 될 수 없다.
        ...
        * 또한 작성 여부에 따라서 명시적과 묵시적으로 구분한다.
        * */

        Animal animal1 = new Rabbit();              // up-casting 의 묵시적 형변환
        Animal animal2 = (Animal) new Rabbit();     // up-casting 의 명시적 형변환

        Rabbit rabbit1 = (Rabbit) animal1;          // down-casting 의 명시적 형변환
        //Rabbit rabbit2 = animal2;                 // down-casting 은 묵시적 형변환이 안 됨
