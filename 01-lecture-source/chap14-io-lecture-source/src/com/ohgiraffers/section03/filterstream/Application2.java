...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 표준 스트림 형태로 제공하고 있다. System 클래스에 필드 in/out/err 가 대상 데이터의 스트림을 말한다.
        ...
        * */
        ...
        /* System.in 을 InputStreamReader 로 변환하여 바이트 기반의 스트림을 문자 기반의 스트림으로 변환 후
        버퍼를 이용한 보조 스트림과 연결함*/
