...
public class Application3 {
    public static void main(String[] args) {
        ...
        /*
        * AND 연산과 OR 연산의 특징
        * 논리식 && 논리식 : 하나라도 false면 항상 false / 앞에 결과가 false면 뒤를 실행 안함.
        ...
        * */
        ...
        /*2. 논리식 || 논리식 : 앞에 결과가 true 이면 뒤를 실행 안함*/
        /*조건식 중 둘 중 하나라도 true를 반환하면 true를 반환하기 때문에 앞에서 미리 true를 나오게 되면 뒤에 조건을 확인할 필요없이 true를 반환한다.
