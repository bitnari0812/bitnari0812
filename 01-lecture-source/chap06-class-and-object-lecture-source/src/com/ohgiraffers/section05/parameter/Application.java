...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("인자로 전달하는 값 = " + iarr);          // 이렇게만 출력하면 얕은복사되어 배열의 주소값 출력됨
        pt.testPrimaryTypeArray(iarr);

        System.out.print("변경된 원본 배열의 값 출력 : ");            // 얕은 복사면 값이 동일하게 변경됨.(복습)
        ...
        pt.testVariableLengthArray("유관순","볼링"); // 한개도 전달가능
