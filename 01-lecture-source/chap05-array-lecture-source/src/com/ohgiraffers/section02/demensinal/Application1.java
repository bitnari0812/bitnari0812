...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*1. 배열의 주소를 보관한 래퍼런스 변수 선언(stack)*/
        int[][] iarr;
        int iarr2[][];
        int[] iarr3[];

        /*2. 여러 개의 1차원 배열 주소를 관리하는 배열을 생성(heap)*/
        /*
        * heap에 공간을 할당할 때 new 연산자를 이용한다.
        * 배열의 주소를 관리하는 배열의 길이는 앞부분에 정수형으로 표기하며 반드시 크기를 지정해줘야 한다.
        * */
        ...
        /*4-2. 배열을 중첩 for문을 이용해서 배열값 출력하기*/
