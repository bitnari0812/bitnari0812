...
public class Application3 {
    public static void main(String[] args) {
        ...
        /*깊은 복사에 대해 이해할 수 있다.
        *
        * 깊은 복사는 heap에 생성된 배열이 가지고 있는 값을 또 다른 배열에 복사해놓은 것이다.
        * 서로 같은 값을 가지고 있지만, 두 배열은 서로 다른 배열이기 때문에 하나의 배열을 변경하더라도 다른 배열에는 영향을 주지 않는다.
        * */
        ...
        * clone()은 이전 배열과 같은 배열 방밖에 만들 수 없다는 특징을 가지고 그 외 3가지 방법은 복사하는 길이와 배열의 길이를 마음대로 조절할 수 있다는 특징을 가지고 있다.
        * */
        ...
        System.arraycopy(originArr,0,copyArr3,3,originArr.length);   //81628611
        print(copyArr3);
