...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        /*상수의 명명 규칙은 변수의 명명 규칙과 컴파일에러를 발생시키는 규칙은 동일하다.
        * 단, 개발자끼리 암묵적인 규칙에 대해 일부 차이를 보인다.
        * 1. 모든 문자는 영문자 대문자 혹은 숫자만 사용한다. -> 숫자로 시작할 수 없는 규칙에 의거, 대문자 이후 써야함
        ...
        *  */
        ...
        final int minAge = 30; // 오류는 나지 않지만 변수와 구분하기 힘듦 (camel case)
