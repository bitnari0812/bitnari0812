...
public class Application2 {
        ...
        public static void main(String[] args){
                ...
                byte bnum;       //1byte
                short snum;      //2byte
                int inum;        //4byte  //대표자료형
                long lnum;       //8byte

                /*실수를 취급하는 자료형은 2가지가 있다.*/
                float fnum;      //4byte
                double dnum;     //8byte  //대표자료형
                ...
                /*2. 변수의 값을 대입한다. (값 대입 및 초기화)*/
                /*2-1. 정수를 취급하는 자료형태 값 대입*/

                bnum = 1;        //byte는 -128~+127        까지 가능
                snum = 2;        //shorts는 -32768~32767
                inum = 3;        //int는 -2147483648~2147483647
                //lnum = 8;      //long은 -9223342036854775808 ~
                                 // 아무 문제 없을 것 같지만 뒤에 대문자 L을 붙여야 한다. 그 이유는 형변환에서 알려드림
                lnum = 8L;


                /*2-2. 실수를 취급하는 자료형 값 대입*/
                //fnum = 4.0;
                fnum = 4.0f;  //(반드시) f 붙여야 함
                dnum = 8.0;   //d 붙여도 작동됨 (필수 아님)


                /*2-3. 문자를 취급하는 자료형 대입*/
                ch = 'a';     //문자 형태의 값을 저장할 수 있다. (홀따옴표)
                ch2 = 97;     //아스키 코드와 관련된 숫자만 넣을 수 있음 'a'는 97였지? 그래서 숫자로도 저장할 수 있다.
                ...
                System.out.println("ch2의 값 출력 : "+ch2); //97로 대입했지만 a로 출력됨

                System.out.println("isTrue의 값 출력 : "+isTrue); //코딩은 위에서부터 아래로 (최신정보)
