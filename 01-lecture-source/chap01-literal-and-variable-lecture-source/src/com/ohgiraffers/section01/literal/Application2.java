...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        /*값의 형태에 따라 사용할 수 있는 연산자(더하기, 빼기, 곱하기, 나누기 등)의 종류와 연산의 결과가 달라진다*/
        ...
        System.out.println(123-23); //숫자 사이의 공백은 허용안됨 (예시, 123 23-> 출력안됨)
        System.out.println(123*10);
        System.out.println(123/10); //소수점 아래 나오지 않음
        System.out.println(123%10); //소수점 아래만 나옴
        //정수와 정수의 연산이기 때문(짝, 홀)//
        ...
        /*정수와 실수의 연산의 결과는 항상 실수(소수점)만 나온다*/
        ...
        /*지금은 계산 결과가 왜 이렇게 나왔는지보다 연산이 가능하다는 것에 집중하자!*/
        ...
        /*문자는 숫자로 취급, 지금까지의 연산은 숫자끼리의 연산, 사칙연산을 따름*/
        ...
        System.out.println("===========문자열과 정수의 연산===========");
        ...
        /*연산 결과는 다른 형태의 값들도 문자열로 취급하여 문자열 이어붙이기(문자열 합치기) 결과가 나옴*/
        /*쌍따옴표가 우선순위를 가진다*/

        /*주의사항. 숫자로 된 문자열의 형태의 값은 '+' 연산의 결과가 문자열 합치기 결과가 되는 것을 주의*/
        System.out.println("===========문자열 형태의 숫자값 '+'연산===========");
        System.out.println("123"+"456"); //계산이 되는게 아니라 문자열 합치기가 됨

        /*4. 논리값 연산*/
        /*4-1. 논리값과 논리값 연산*/
        /*논리값끼리 연산은 모든 연산자 사용이 불가능하다*/
        //System.out.print(true+false); //에러발생
        //System.out.print(true-false); //에러발생
        //System.out.print(true*false); //에러발생
        //System.out.print(true/false); //에러발생
        //System.out.print(true%false); //에러발생
        ...
        //System.out.println(true-"a"); //오류발생
        //System.out.println(true*"a");
        //System.out.println(true/"a");
        //System.out.println(true%"a");
