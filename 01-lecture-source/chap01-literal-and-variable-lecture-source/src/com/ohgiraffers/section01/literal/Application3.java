...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(9+9+"9"); //189 // *연산 방향은 왼쪽에서 오른쪽* (숫자부터 합쳐짐)

        System.out.println("9"+(9+9)); //918 (괄호가 우선순위)
        ...
        System.out.println("10과 20의 합 : "+(10+20)); //괄호를 묶지 않으면 문자열 합치기가 되어서 결과가 1020이 됨
        System.out.println("10과 20의 차 : "+(10-20)); //문자열은 마이너스 연산이 불가능하기에 문자열 합치기가 안 됨(반드시 괄호 사용)
