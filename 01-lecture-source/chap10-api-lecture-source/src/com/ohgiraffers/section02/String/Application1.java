...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * charAt() : 해당 문자열의 인덱스에 해당하는 문자를 반환한다. () 안의 값은 인트 인덱스의 값
        * 인덱스는 0부터 시작하는 숫자체계를 의미하며, 인덱스를 벗어난 정수를 인자로 전달하는 경우 indexOutBoundsException 발생한다.
        * */
        String str = "apple";

        for(int i = 0; i<str.length(); i++){
            System.out.println("chaAt("+i+") : "+str.charAt(i));
        }
        ...
        * 단, 이 메소드는 대소문자를 구분하여 비교한다.*/
        ...
        String str4 = "JAVA";
        String str5 = "oracle";
        System.out.println("compareTo() : "+(str2.compareTo(str3)));   //0을 반환
        ...
        System.out.println("compareTo() : "+(str5.compareTo(str2)));   //5     양수인지, 음수인지 판단할 때 사용


        /*concat() : 문자열에 인자로 전달한 문자열을 합치기해서 새로운 문자열을 반환한다.
        * 원본 문자열에는 영향을 주지 않는다. (밑에 메소드들도 마찬가지)
        * */
        ...
        * 단, 일치하는 문자가 없는 경우 -1을 반환한다.
        * */
        System.out.println("lastIndexOf('a') : "+indexOf.lastIndexOf('a'));  // 7 (공백도 인덱스 값을 씀)
        ...
        System.out.println("trimStar = #"+trimStr+"#");
        ...
        * substring() : 문자열 일부분을 잘라내어 새로운 문자열을 반환한다.*/
        ...
        System.out.println("substring(3.6) : "+javaoracle.substring(3,6));          //3부터 6 전까지 라는 뜻
        System.out.println("substring(3) : "+javaoracle.substring(3));    //3부터 끝까지 출력
        ...
        * replace() : 문자열에서 대체할 문자열로 기존 문자열을 변경해서 변환한다.*/
        ...
        /*
        * length() : 문자열의 길이를 정수형으로 변환한다. 1부터 시작함*/
        System.out.println("length() : "+javaoracle.length());
        System.out.println("빈 문자열을 포함한 길이 : "+(" java ".length()));
