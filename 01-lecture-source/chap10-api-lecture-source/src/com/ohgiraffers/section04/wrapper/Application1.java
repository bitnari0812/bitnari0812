...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 상황에 따라 기본타입의 데이터를 인스턴스화해야 하는 경우가 발생한다.
        * 이때 기본타입의 데이터를 먼저 인스턴스로 변환 후 사용해야 하는데,
        * 8가지 기본타입 데이터를 인스턴스화할 수 있도록 하는 클래스를 Wrapper 클래스라고 한다.
        ...
        * */
        ...
        /*기본 타입을 래퍼런스의 인스턴스로 인스턴스화하는 것을 박싱이라고 하며
        ...
        * */
        ...
        System.out.println("int와 Integer 비교 : "+(inum == integerNum1));  //true. 값은 같지만 주소는 다름
        System.out.println("int와 Integer 비교 : "+(inum == integerNum3));  //true.

        System.out.println("Integer와 Integer 비교 : "+(integerNum1 == integerNum2));  //false. 생성자로 만들어서 서로 다른 값임
        System.out.println("Integer와 Integer 비교 : "+(integerNum1 == integerNum3));  //false 오토박싱이라 다름.
        System.out.println("Integer와 Integer 비교 : "+(integerNum3 == integerNum4));  //true 오토박싱끼리는 같음.

        System.out.println("equals() : "+(integerNum1.equals(integerNum2)));          //값이 같기에 이퀄 메소드 이용하면 true
