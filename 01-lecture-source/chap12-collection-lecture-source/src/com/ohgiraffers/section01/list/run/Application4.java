...
public class Application4 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("integerStack.search(5) = " + integerStack.search(5));   // 후입선출이라 1이 나옴.
        
        /*
        * peek() : 해당 스택의 가장 마지막에 있는(상단에 있는) 요소 반환
        * pop() : 해당 스택의 가장 마지막에 있는(상단에 있는) 요소를 반환 후 제거
        * */
        System.out.println("integerStack.peek() = " + integerStack.peek());    // 5
        System.out.println("integerStack = " + integerStack);

        System.out.println("integerStack.pop() = " + integerStack.pop());      // 5
        System.out.println("integerStack = " + integerStack);                  // 5가 사라져있음
