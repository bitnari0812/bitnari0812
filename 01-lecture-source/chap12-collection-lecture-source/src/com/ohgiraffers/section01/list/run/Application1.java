    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        for(int i = 0; i<arrayList.size(); i++){
            System.out.println(i+" : "+arrayList.get(i));   //size를 활용해서 인덱스 값을 가져올때는 이렇게
        }
        ...
        /*Collection 인터페이스가 아니라 Collections 클래스이고 static 메소드이다.
        ...
        * LinkedList 타입으로 형변환 후 descendingIterator()
        ...
        * */
        ...
        System.out.println("---------------------------------------------------");
        while (dIter.hasNext()){
            System.out.println(dIter.next());  // 한번 꺼냈으면 다시 출력할 수 없음
        }
*/
